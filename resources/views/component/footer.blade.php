    ...
    <div class="mid-footer">
                ...
                <div class="col-12 col-lg-4 ft-info">
                    ...
                    <div class="social-footer">
                        <div class="social toggle-mn">
                            ...
                            <a class="tt" href="https://twitter.com/" target="_blank"
                                aria-label="Twitter" title="Theo dõi Bean Water trên Twitter">
                                <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a class="yt" href="https://www.youtube.com/" target="_blank"
                                aria-label="Youtube" title="Theo dõi Bean Water trên Youtube">
       ...
       C512,181.088,504.704,138.592,490.24,113.92z M192,352V160l160,96L192,352z"></path>
                            ...
                            <a class="ins" href="https://www.instagram.com/" target="_blank"
                                aria-label="Instagram" title="Theo dõi Bean Water trên Instagram">
                    ...
                    <div class="link-list col-footer footer-click">
                        ...
                        <ul class="list-menu hidden-mobile">
                            ...
                            <li class="local_foo"><img width="24" height="24" alt="Location"
                                    data-src="//bizweb.dktcdn.net/100/521/251/themes/960910/assets/tool.png"
                                    class="lazyload"
                        ...
                        <a class="btn-chi-nhanh" href="he-thong-chi-nhanh.html" title="Hệ thống chi nhánh">
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <ul class="thanhtoan">
                        <li><img width="108" height="66" alt="Payment 1"
                                data-src="//bizweb.dktcdn.net/100/521/251/themes/960910/assets/payment_1.png"
                                class="lazyload"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC">
                        </li>
                        <li><img width="108" height="66" alt="Payment 2"
                                data-src="//bizweb.dktcdn.net/100/521/251/themes/960910/assets/payment_2.png"
                                class="lazyload"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC">
                        </li>
                        <li><img width="108" height="66" alt="Payment 3"
                                data-src="//bizweb.dktcdn.net/100/521/251/themes/960910/assets/payment_3.png"
                                class="lazyload"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC">
                        </li>
                        <li><img width="108" height="66" alt="Payment 4"
                                data-src="//bizweb.dktcdn.net/100/521/251/themes/960910/assets/payment_4.png"
                                class="lazyload"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC">
                        </li>
                    </ul>
